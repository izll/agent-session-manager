...
const PatternsURL = "https://raw.githubusercontent.com/izll/agent-session-manager/main/session/patterns.json"
...
func patternsPath() (string, error) {
	...
	dir := filepath.Join(home, ".config", "agent-session-manager")
